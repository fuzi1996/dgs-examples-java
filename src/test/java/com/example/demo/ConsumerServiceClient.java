...
public class ConsumerServiceClient {
    ...
    public static UserInfo getUserInfoById(int userId, String clientVersion) {
        ...
        return new UserInfo(userId, userId * 10 % 100, userId + "_name",
            userId + "dugk@foxmail.com", clientVersion);
    }
    ...
    public static List<UserInfo> batchUserInfoByIds(List<Integer> userIdList,
        ...
        return userIdList.stream().map(userId -> getUserInfoById(userId, clientVersion))
    ...
    public static NewUserInfo getNewUserInfoById(String redisKey) {
        ...
        return new NewUserInfo(Integer.parseInt(split[2]), split[0] + "_" + split[1],
            Integer.parseInt(split[2]) % 2 == 0);
    }
