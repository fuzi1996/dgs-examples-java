...
public class MarketingServiceClient {
    ...
    static class Coupon {
        ...
        public Coupon(int couponId, int base, int price, int limitation, String couponText,
            List<Integer> bindingItemIds) {
    ...
    public static Coupon getCouponInfoById(int couponId) {
        List<Integer> bindingItemIds = IntStream.range(couponId, couponId + 10).boxed()
    ...
    public static List<Coupon> batchCouponInfoByIds(List<Integer> couponIdList) {
        return couponIdList.stream().map(MarketingServiceClient::getCouponInfoById)
            .collect(Collectors.toList());
    }
