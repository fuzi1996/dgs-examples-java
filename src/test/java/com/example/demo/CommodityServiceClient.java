...
public class CommodityServiceClient {
    ...
    static class ItemBaseInfo {
        ...
        public ItemBaseInfo(int itemId, int sellerId, String name, int salePrice, int stockAmount,
            boolean onSale, int saleAmount, List<SkuInfo> skuList) {
            this.itemId = itemId;
            this.sellerId = sellerId;
            this.name = name;
    ...
    public static List<ItemBaseInfo> batchItemBaseInfoByIds(List<Number> itemIds) {
        ...
        return itemIds.stream().map(CommodityServiceClient::getItemBaseInfoById)
